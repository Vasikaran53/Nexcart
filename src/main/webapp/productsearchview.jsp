...
<div class="small-container single-product">
    <div class="rows">
        <%
            String searchParam = request.getParameter("n1");

            if (searchParam != null && !searchParam.isEmpty()) {
                try {
                    int productId = Integer.parseInt(searchParam);
        ...
        %>
        <div class="col-2">
            <img src="<%= rs.getString("pimage") %>" width="100%" id="ProductImg" />
        </div>
        <div class="col-2">
            <p>Home </p>
            <h2><%= rs.getString("pname") %></h2>
            <h4>$<%= rs.getString("pprice") %></h4>
            <select name="" id="">
            ...
            <a href="cart.jsp?id=<%= rs.getString("pid") %>" class="btn">Add to Cart</a>
        ...
        <%
                    ...
                    out.println("<p>Invalid product ID. Please enter a valid number.</p>");
                } catch (Exception e) {
                    out.println("<p>Error: " + e.getMessage() + "</p>");
                }
            } else {
                out.println("<p>Please enter a product ID to search.</p>");
            }
        %>
    </div>
</div>
