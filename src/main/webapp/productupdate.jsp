...
<input type="text" placeholder="search" name ="n1" >
	...
	try{
          ...
          <div class="container">
        	 <form action="productupdate" method="post">
        	  ...
        	  <h4>Product Price</h4>
        	  <input type="text" name="pprice" value="<%=rs.getString(3) %>"/>
        	  <h4>Product Quantity</h4>
        	  <input type="text" name="pquantity" value="<%=rs.getString(4) %>"/>
        	   <input type="text" name="pimage" value="<%=rs.getString(5) %>"/>
