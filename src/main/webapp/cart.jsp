                ...
                <tbody>
                    ...
                    <tr>
                        <td class="thumbnail-img">
                            <a href="productdetails.jsp?id=<%= rs.getString("pid") %>">
                                <img class="img-fluid" src="<%= rs.getString("pimage") %>" alt="Product Image" />
                            </a>
                        </td>
                        <td class="name-pr">
                            <a href="productdetails.jsp?id=<%= rs.getString("pid") %>">
                        ...
                        <td class="total-pr">
                            <p>$<%= 1 * rs.getDouble("pprice") %></p>
                        </td>
                        <td class="remove-pr">
                            <a href="cart.jsp?product_id=<%= rs.getString("pid") %>">
