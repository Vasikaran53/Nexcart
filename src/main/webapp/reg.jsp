...
<body>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="right-phone-box">
                        <p>Call US :- <a href="#"> 9384417036</a></p>
                    </div>
                    <div class="our-link">
                        <ul>
   ...
   <br> <br> 
    <!-- End Top Search -->
   <div class="container">
        <form action="reg" method="post" class="signup-form">
            <h2 class="h2">Create an account</h2>
            <p id="p">Enter your details below</p><br>
            ...
            <button type="submit" class="cr-a">Create Account</button>
            <button type="submit" class="co-g">Sign up  with google</button>
             <p class="Already">Already have account ? <a href="login.jsp">Log in</a></p>
        </form>
    </div>
